...
<div><h1>
Admin Settings</h1>
<p style="margin-bottom:0;">You can change this configuration much later.</p>
</div>
</li>

            <li>
                <label for="Form_Garden-dot-Title">Application Title</label>
<input type="text" name="site_name" value="<?= config_item('site_name') ?>" class="InputBox" required/></li>

<li>
    <label>Admin Username</label>
<input type="text" name="admin_username" value="<?= config_item('dbase_admin_username') ?>" required class="InputBox" />            </li>

            <li>
                <label>Admin Email</label>
<input type="email" name="admin_email" value="<?= config_item('dbase_admin_email') ?>" required class="InputBox" />            </li>
            <li>
                <label>Admin Password</label>
<input type="text" name="admin_password" value="<?= config_item('dbase_admin_password') ?>" required class="InputBox" />            </li>
